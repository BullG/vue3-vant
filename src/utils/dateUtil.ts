 ...
 * 
 * @Author: 酋小怪
 * @Date: 2020-12-24 15:35:05
 * @LastEditTime: 2020-12-25 10:09:21
 * @LastEditors: 酋小怪
 * @Description: 日期方法
 * @FilePath: \loan-apply-cli\src\utils\dateUtil.ts
 */
...
export function formatToDateByZh(date: moment.MomentInput = null):string{
...
export function formatDateForRequest(time:string):string{
