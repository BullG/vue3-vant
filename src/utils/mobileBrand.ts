 ...
 * 
 * @Author: 酋小怪
 * @Date: 2021-01-12 18:12:44
 * @LastEditors: 酋小怪
 * @LastEditTime: 2021-01-26 16:17:42
 * @Description: file content
 * @FilePath: \src\utils\mobileBrand.ts
 */
 ...
 * @Date: 2021-01-12 18:12:44
 * @LastEditors: 酋小怪
 * @LastEditTime: 2021-01-18 14:18:16
 * @Description: 手机浏览器相关
 * @FilePath: \src\utils\mobileBrand.js
 */


export function judgeBrand(sUserAgent:any):string {
...
export function getIosVer() {
    ...
    if (judgeBrand(str) == 'iphone') {
        const ver = str.match(/iphone os (.*?) like mac os /)
            // cpu iphone os 13_2_3 like mac os x

        return ver&&ver[1].replace(/_/g, ".")
    }
    return ''    
}